		...
		with tqdm(total=self.stream_total_frames) as pbar:
			for iframe in range(self.stream_total_frames):
				...
				for overlay_data in active_events:
					...
					# TODO: release the overlayed video
...
directory_path = "/Users/adrianromanguzman/Downloads/MUSIC_dataset_script/data"
...
video_overlay = AudioVisualSynthesizer(input_360_video_path, output_video_path, rirs, source_coords, overlay_video_paths,
